            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <svg class="fill-current text-gray-800 mr-2 size-11 hover:text-gray-500 transition-colors" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
