...
<body>
    ...
    <h1 class="text-center mt-10 font-bold text-3xl">{{ __("CARRITOS") }}</h1>
    @if($carts->isEmpty())
        <h2 class="text-center text-xl text-gray-500 mt-5">{{ __("¡No tienes ningun carrito!") }}</h2>
    @endif
